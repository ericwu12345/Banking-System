...
-- create customer
--? are output paramters, because we do not know what they are, ? = placeholder for output, if we call w/o em, we dont have the right number
--of parameters
--provide own sqlcode when we encounter errors
--
...
-- "P2.ACCOUNT.SQL191125015639480" is not equal to any value of the parent key of the parent table.  SQLSTATE=23503
...
--deposit with negative balance  depositing into a closed account
