...
--make completely new file to turn in, this is just an example, bold are output paramters in the section b of hw desc.
--not changing anything form the files he gives us
--db2 -td"@" -f proc.sql
--sql statement logic from 1-7 should be identical, instead of variable in java, we use the actual statement
